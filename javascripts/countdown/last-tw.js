...
function twitterCallback2(twitters) {
  ...
  var statusHTML = ['<div class="span12"><h5>Latest tweets <a class="hidden-tablet" href="http://twitter.com/'+username+'" target="_blank">@'+username+'</a></h5></div>'];
  for (var i=0; i<twitters.length; i++){
    ...
    statusHTML.push('<div class="span4"><p>' +status+ '</p><span class="tweet-date">'+relative_time(twitters[i].created_at)+'</span></p></div>');
  }
